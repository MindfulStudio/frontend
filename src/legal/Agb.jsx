const agb = (
  <div>
    ...
    <p className="text-sm">
      Die App wurde zu Demonstrationszwecken entwickelt und befindet sich in
    ...
    <p className="text-sm mb-2">
      ...
      App übernehmen keine Haftung für Schäden, die durch die Nutzung der App
      entstehen könnten, einschließlich Datenverlust oder unbefugtem Zugriff auf
      persönliche Informationen.
    </p>
    <h2 className="text-sm font-semibold mt-2">3. Nutzung der App</h2>
    <p className="text-sm mb-2">
      Die Nutzung der App ist kostenlos und nicht kommerziell. Die App dient
      lediglich zu Demonstrationszwecken. Nutzer:innen wird empfohlen, keine
      echten personenbezogenen Daten einzugeben.
    </p>
    ...
    <p className="text-sm mb-2">
      Mit der Nutzung der App erklärst du dich damit einverstanden, dass deine
