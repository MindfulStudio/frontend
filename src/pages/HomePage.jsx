  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center min-h-screen bg-slate-900 ">
        <Card className="flex flex-col items-center h-screen bg-background">
          {/* Cookies */}
          <div className="flex justify-center w-full">
            <Cookies />
          </div>
          {/* login */}
          <section className="  pt-[109px] px-[50px] flex flex-col items-center pb-10 w-[400px]">
            ...
            <p className=" pt-3 pb-6">
              ...
              Reaktionen besser zu verstehen und ihre Zusammenhänge zu
              erforschen. Mit der Zeit kannst du so ein tieferes Verständnis für
          ...
          {/* register */}
          <section className="flex justify-center bg-black w-full flex-grow">
